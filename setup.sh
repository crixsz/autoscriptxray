...
END
wget -q -O /etc/nginx/conf.d/grpc.conf https://raw.githubusercontent.com/crixsz/autoscriptxray/main/config/grpc.conf

# wget -q -O /etc/nginx/nginx.conf https://raw.githubusercontent.com/crixsz/autoscriptxray/main/config/nginx.conf
...
echo ""
echo -e "${BB}—————————————————————————————————————————————————————————${NC}"
echo -e "                  ${WB}XRAY SCRIPT BY CRIXSZ${NC}"
echo -e "                  ${WB}CREDIT TO: DUGONG / SYIHABX ${NC}"
echo -e "${BB}—————————————————————————————————————————————————————————${NC}"
